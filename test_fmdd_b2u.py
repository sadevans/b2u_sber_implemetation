...
parser.add_argument('--test_dirs', type=str, default='./dataset/small/validation')
...
#     fns = glob.glob(os.path.join(dataset_dir, "*.tif"), recursive=True)
#     fns.sort()
#     data_noisy = []
#     data_gt = []
#     for fn in fns:
...
valid_dict = {
    opt.subfold: validation_fmdd(opt.test_dirs)
}
